...
<div class="row shadow p-3 mb-5 bg-white rounded" style="margin-top:20px;margin: auto;width: 100%;padding: 10px;height: 100%;">
	...
	<form method="POST" action="{{route('company.config.update')}}" enctype="multipart/form-data">
            {!! csrf_field() !!}
  ...
  <div class="form-group row mb-3">
    ...
    <div class="col-md-4">
      ...
      <input type="text" class="form-control" id="txtphone" name="txtphone" placeholder="Ingrese su número" value="{{$contact_phone}}">
    </div>
  </div>
