            ...
            <nav id="sidebar" class="active">
                ...
                <ul class="container_sesion">
                    ...
                    <li class="title_sesion">
                        ...
                        <strong>
                            <div class=number_sesion>{{$loop->iteration}}</div>
                        </strong>
                        <li class="list_temas">
                    ...
                    @endforeach
                    <li>
                        <a href="{{route('teacher.themes.edit', $theme->id)}}">Volver a docente</a>
                    </li>
                </ul>         
            </nav>
                ...
                <div class="container_principal">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-8 container_left">
                            <!-- ///////////////////////////     VIDEO E IMAGENES    //////////////////////////////-->
                            @foreach($theme->multimedia as $multimedia)
                                ...
                                <div class="tab-content p-3" id="nav-tabContent">
                                    ...
                                    <div class="tab-pane fade" id="nav-materiales" role="tabpanel" aria-labelledby="nav-materiales-tab">           
                                        <div class ="content_materiales">
                                            ...
                                            <div class="material">
                                                <span class="fas fa-file-signature text-dark mr-2"></span> {{$attachment->name}} 
                                                <a href="{{asset($attachment->url)}}" target="_blank" class="float-right text-right" title="Descarga material">
